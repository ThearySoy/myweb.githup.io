      ...
      <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-10 col-md-3 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="col-12 mt-3">
                      <div class="form-check">
                        ...
                        <label class="small form-check-label" for="rememberMe">Remember me</label>
                        <a href="<?php echo e(url('forgot-password')); ?>" class="small flex items-center justify-end mt-4">Forgot Password</a>
                    </div>
                    </div>
                    <div class="col-12 mt-3">
...
</html><?php /**PATH C:\wamp64\www\website\resources\views/auth/login.blade.php ENDPATH**/ ?>