        ...
        <div class="row mb-5">
          ...
          <div class="d-md-flex post-entry-2 half">
            <a href="#" class="me-4 thumbnail">
              <img src="<?php echo e(asset('frontend/assets/img/post-landscape-2.jpg')); ?>" alt="" class="img-fluid">
            </a>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="<?php echo e(asset('frontend/assets/img/person-3.jpg')); ?>" alt="" class="img-fluid rounded-circle w-50 mb-4">
...
<?php echo $__env->make('frontend.main-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\website\resources\views/frontend/aboutus.blade.php ENDPATH**/ ?>